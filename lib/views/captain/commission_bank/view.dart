      ...
      child: Scaffold(
        ...
        body: BlocBuilder<BankCubit,BankStates>(
          builder: (context, state) {
            ...
            return bankData == null ? Center(child: Empty()) : Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 30),
              child: RefreshIndicator(
                onRefresh: BankCubit.of(context).getBanks,
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            cubit.imageFileList.isEmpty ?  MaterialButton(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(10),
                                    color: kWhiteColor),
                                child: Icon(FontAwesomeIcons.camera, color: kDarkGreyColor,
                                ),
                              ),
                            ) : MaterialButton(
                          ...
                          ConfirmButton(
                            title: 'ارسال',
                            onPressed:(){
                              if (cubit.TransferValidate()) {
                                cubit.transferAccountBank();
                                RouteManager.navigateTo(CommissionBankView());
                              } else {
                                showSnackBar(
                                  'برجاء رفع الصور أولا',
                                  errorMessage: true ,
                                );
                              }
                            } ,
